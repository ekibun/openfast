...
EXTERNAL_ROUTINE void FAST_Simulink_Trial(int *iTurb, int *TrialIteration, int *NumInputs, int *NumOutputs, double *InputAry, double *OutputAry, int *ErrStat, char *ErrMsg);
